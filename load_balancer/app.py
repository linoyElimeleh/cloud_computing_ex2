...
def check_time_first_in_line():
    dif = datetime.utcnow() - job_queue[0]["entry_time_utc"]
    return dif.seconds
...
def scale_up():
    ...
    if job_queue and check_time_first_in_line() > MAX_Q_TIME_SEC:
...
def add_job_to_queue():
    if request.method == "PUT":
        ...
        job_queue.append(
            {"job_id": job_id, "entry_time_utc": entry_time_utc, "iterations": int(request.args.get("iterations")),
